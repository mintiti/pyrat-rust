from pyrat_engine._core.builder import MazeLayout
...
class PyRat:
    ...
    ) -> tuple[bool, float, float, PyGameObservation, PyGameObservation]: ...
    ...
    def get_observations(self) -> tuple[PyGameObservation, PyGameObservation]: ...
