 ...
 */
export type BotInfoEvent = { match_id: number; sender: PlayerSide; player: PlayerSide; turn: number; multipv: number; target: Coord | null; depth: number; nodes: number; score: number; pv: Direction[]; message: string }
